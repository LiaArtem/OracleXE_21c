--------------------------------------------------------
--  DDL for Package Body P_INTERFACE_PIPE
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "TEST_USER"."P_INTERFACE_PIPE" 
as
    ...
    begin
      ...
      then  
         ...
         p_url := 'https://bank.gov.ua/NBUStatService/v1/statdirectory/exchange?valcode='||p_currency||'1='||to_char(p_date,'yyyymmdd')||p_dop_param;
      end if;
